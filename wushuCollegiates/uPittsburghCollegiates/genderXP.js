$.getJSON("2016.json", function(data) {
	...
	var tooltipM = d3.select("#genderXPParagraph")
	    ...
	    .html("There are " + begcount[0] + " people in <br>" + "the female beginner divisions,<br>" + intcount[0] + " in female intermediate,<br>" + "and " + advcount[0] + " in female advanced!");
    ...
    var tooltipF = d3.select("#genderXPParagraph")
	    ...
	    .style("font-size", "12px")
	    .style("text-align", "center")
	    .html("There are " + begcount[1] + " people in <br>" + "the male beginner divisions,<br>" + intcount[1] + " in male intermediate,<br>" + "and " + advcount[1] + " in male advanced!");
